...
// 'key' from the BST.
bool deleteIterative(treeNode* root, int key)
{
    treeNode* curr = root;
    treeNode* prev = NULL;
    ...
    if (curr->left == NULL || curr->right == NULL) {
        ...
        if (prev == NULL)
            std::cout << newCurr -> data << " is deleted" << std::endl;
            return true;
